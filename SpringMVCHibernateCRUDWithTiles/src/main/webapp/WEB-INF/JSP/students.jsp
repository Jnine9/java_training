...
<body> 
	<div class="wrapper">
		<h3>Student Data</h3>
		<form:form method="post" action="${pageContext.request.contextPath}/student"
				...
				<div class="table-responsive">
						<table class="table table-bordered" style="width: 500px">
								<tr>
										...
										if(ids != null){
											%>
											<form:input type="text" path="id" value="<%=ids %>" hidden="hidden"/>
											<%
										}
											%>
		...
		<table class="table table-bordered" style="width: 500px">
				...
				<c:forEach items="${studentList}" var="student">
						<tr>
								...
								<td width="150" align="center"><a href="${pageContext.request.contextPath}/edit/${student.id}">Edit</a>/<a
